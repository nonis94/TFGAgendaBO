package com.example.agenda.tfgagenda.sql;
...
/**
 * Created by Nonis123 on 20/03/2018.
 */
...
public class BDSQLite extends SQLiteOpenHelper {
    ...
    private String DROP_EVENTOS_TABLE = "DROP TABLE IF EXISTS " + TABLE_EVENTOS;

    public BDSQLite(Context context){
        super(context,DATABASE_NAME,null,DATABASE_VERSION);
    }

    private String CREATE_EVENTOS_TABLE = "create table eventos(" +
    ...
    public void onCreate(SQLiteDatabase db){
        Log.d("myTag", "prova de debug");
        Log.wtf("wtf","prova de printtt");
