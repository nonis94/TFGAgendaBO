...
//Classe on inserim els missatges a l'altre conversa que tinguem oberta.

//Per personalitzar ListChatMessage
...
//AQUIIIIII INSERIM ELS MISSATGES A L'ALTRE CONVERSA!!!!!!!!!!!
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = convertView;
        if(convertView==null){
            LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            //Comprovem que els missatges siguin enviats per l'usuari actual, per tant utilitzem el template de list_Send_message
